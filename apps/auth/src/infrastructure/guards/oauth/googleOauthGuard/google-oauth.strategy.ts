...
import type { IOAuthUseCases } from 'apps/auth/src/domain/useCases/oAuth/oauth-use-cases.interface';
...
export class GoogleOauthStrategy extends PassportStrategy(Strategy, 'google') {
  ...
  public async validate(accessToken: string, refreshToken: string, profile: Profile, cb: any): Promise<LocalUserModel> {
